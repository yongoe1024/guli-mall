...
MySQL - 8.0.30 : Database - gulimall_pms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`gulimall_pms` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `pms_attr` (
  ...
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '属性图标',
...
CREATE TABLE `pms_attr_group` (
  ...
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '组图标',
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='品牌';

/*Data for the table `pms_brand` */

insert  into `pms_brand`(`brand_id`,`name`,`logo`,`descript`,`show_status`,`first_letter`,`sort`) values 
(6,'华为','https://gulimall-mrguo.oss-cn-beijing.aliyuncs.com/2022-10-06/c93b990d-e965-4b63-81da-3192abf89f90_retouch_2022082218101242.jpg','啊啊啊',0,'H',1),
(7,'小米','https://gulimall-mrguo.oss-cn-beijing.aliyuncs.com/2022-10-06/53fcd081-f012-4360-8d20-3d4a3685adfa_IMG_20220822_193929.jpg','w',1,'x',0);
...
(22,'电子书刊',1,2,1,1,NULL,NULL,0),
(23,'音像',1,2,1,0,NULL,NULL,0),
(24,'英文原版',1,2,1,2,NULL,NULL,0),
(25,'文艺',1,2,1,3,NULL,NULL,0),
(26,'少儿',1,2,1,4,NULL,NULL,0),
(27,'人文社科',1,2,1,5,NULL,NULL,0),
(28,'经管励志',1,2,1,6,NULL,NULL,0),
(29,'生活',1,2,1,7,NULL,NULL,0),
(30,'科技',1,2,1,8,NULL,NULL,0),
(31,'教育',1,2,1,9,NULL,NULL,0),
(32,'港台图书',1,2,1,10,NULL,NULL,0),
(33,'其他',1,2,1,11,NULL,NULL,0),
...
(1431,'dsa323',1,2,1,12,NULL,NULL,NULL),
...
CREATE TABLE `pms_category_brand_relation` (
  ...
  `catelog_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `pms_sku_images` (
  ...
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片地址',
...
CREATE TABLE `pms_sku_info` (
  ...
  `brand_id` bigint DEFAULT NULL COMMENT '品牌id',
  `sku_default_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '默认图片',
